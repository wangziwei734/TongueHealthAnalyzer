...
def getVec(imgPath):
    colorSpace = [cv2.COLOR_BGR2Lab, cv2.COLOR_BGR2HLS,
                  cv2.COLOR_BGR2RGB]  # 构造色彩空间，cv2.COLOR_BGR2Lab：将BGR格式的图像转换为Lab格式；cv2.COLOR_BGR2HLS：将BGR格式的图像转换为HLS格式；cv2.COLOR_BGR2RGB：将BGR格式的图像转换为RGB格式
